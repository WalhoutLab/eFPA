function [FluxPotentials_2d,FluxPotential_solutions_2d] = FPA2_cluster_simple_decay(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,alpha)
