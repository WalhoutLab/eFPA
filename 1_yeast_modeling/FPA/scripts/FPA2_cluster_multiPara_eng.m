function [FluxPotentials_2d,FluxPotential_solutions_2d] = FPA2_cluster_multiPara_eng(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,base,alpha, distMat_unweighted,labels_unweighted, eng_suffix)
