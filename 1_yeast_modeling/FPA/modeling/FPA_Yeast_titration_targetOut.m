...
base = 2;
alpha = 1;
eng_suffix = 'base2_n6_targetOut';
[FP_collection_2] = FPA2_cluster_multiPara_eng_targetOut(model,targetRxns,{},distMat_wtd,labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro,base,alpha, distMat_normal,labels, eng_suffix);
save('output/Titration_relativeExp_wtdDist_expDecay_base2_n6_7_targetOut.mat','FP_collection_2','targetRxns','n2','base');
...
base = 1000;
alpha = 1;
eng_suffix = 'fine_titration_targetOut';
[FP_collection_2] = FPA2_cluster_multiPara_eng_targetOut(model,targetRxns,{},distMat_wtd,labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro,base,alpha, distMat_normal,labels, eng_suffix);
save('output/Titration_relativeExp_wtdDist_expDecay_FineGrained_targetOut.mat','FP_collection_2','targetRxns','n2','base');
