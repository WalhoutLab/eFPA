...
%% load merged levels
load('output/normalizedLevels_singlePartialExcluded.mat');
%% precalc penalty 
...
save('output/partialGPR/Titration_relativeExp_wtdDist_expDecay_SingleExcluded.mat','FP_collection_2','targetRxns','n2','base');
