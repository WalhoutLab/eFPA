...
% this is for the lysine pathway 
%%
...
%% case 1: the lysine biosynthesis pathway
...
figure;
hold on
myFlux = fluxMat_normalized(strcmp(rxnLabel,rxnCtr),:);
...
myLevel = normalizedLevel_pro_perPro(strcmp(valid_rxns_pro_perPro,rxnID2),:);
Y = myLevel(order0);
...
Y = myLevel(order0);
Y4 = normalize(Y,'range',[0.01 1]);
myLevel = normalizedLevel_pro_perPro(strcmp(valid_rxns_pro_perPro,rxnID5),:);
Y = myLevel(order0);
Y5 = normalize(Y,'range',[0.01 1]);
myLevel = normalizedLevel_pro_perPro(strcmp(valid_rxns_pro_perPro,rxnID6),:);
Y = myLevel(order0);
Y6 = normalize(Y,'range',[0.01 1]);


b = bar(X,[Y1',Y2',Y3',Y4',Y5',Y6']);
b(1).FaceColor = '#0072BD';
b(2).FaceColor = '#D95319';
b(3).FaceColor = '#EDB120';
b(4).FaceColor = '#7E2F8E';
