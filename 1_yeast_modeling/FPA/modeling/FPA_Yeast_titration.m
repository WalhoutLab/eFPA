...
[FP_collection] = FPA_cluster_multiPara(model,targetRxns,{},distMat_normal,labels,n, manualPenalty,{},max(distMat_normal(~isinf(distMat_normal))),blocklist, {},true,penalty_pro);
save('output/Titration_relativeExp_oriDist_oriDecay.mat','FP_collection','targetRxns','n');
%% original FPA with original distance - raw ones
[FP_collection] = FPA_cluster_multiPara(model,targetRxns,{},distMat_normal,labels,n, manualPenalty,{},max(distMat_normal(~isinf(distMat_normal))),blocklist, {},true,penalty_pro_raw);
save('output/Titration_rawExp_oriDist_oriDecay.mat','FP_collection','targetRxns','n');
%% original FPA with wtd distance - normalized ones
[FP_collection] = FPA_cluster_multiPara(model,targetRxns,{},distMat_wtd,labels,n, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro);
save('output/Titration_relativeExp_wtdDist_oriDecay.mat','FP_collection','targetRxns','n');
%% original FPA with original distance - raw ones
[FP_collection] = FPA_cluster_multiPara(model,targetRxns,{},distMat_wtd,labels,n, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro_raw);
save('output/Titration_rawExp_wtdDist_oriDecay.mat','FP_collection','targetRxns','n');
...
base = [1.5 2 exp(1) 3 5 10 100 1000];
[FP_collection_2] = FPA2_cluster_multiPara(model,targetRxns,{},distMat_normal,labels,n2, manualPenalty,{},max(distMat_normal(~isinf(distMat_normal))),blocklist, {},true,penalty_pro,base);
save('Titration_relativeExp_oriDist_expDecay.mat','FP_collection_2','targetRxns','n2','base');
%% FPA2 (new decay formula): orginal distance - raw ones
[FP_collection_2] = FPA2_cluster_multiPara(model,targetRxns,{},distMat_normal,labels,n2, manualPenalty,{},max(distMat_normal(~isinf(distMat_normal))),blocklist, {},true,penalty_pro_raw,base);
save('Titration_rawExp_oriDist_expDecay.mat','FP_collection_2','targetRxns','n2','base');
...
save('Titration_relativeExp_wtdDist_expDecay.mat','FP_collection_2','targetRxns','n2','base');
%% FPA2 (new decay formula): wtd distance - raw ones
[FP_collection_2] = FPA2_cluster_multiPara(model,targetRxns,{},distMat_wtd,labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro_raw,base);
save('Titration_rawExp_wtdDist_expDecay.mat','FP_collection_2','targetRxns','n2','base');
