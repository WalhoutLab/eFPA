...
[FP_collection] = FPA_cluster_multiPara_targetOut(model,targetRxns,{},distMat_wtd,labels,n, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro);
save('output/Titration_relativeExp_wtdDist_oriDecay_targetOut.mat','FP_collection','targetRxns','n');
