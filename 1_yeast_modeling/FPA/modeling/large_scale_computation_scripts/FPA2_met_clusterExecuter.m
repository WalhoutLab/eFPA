function FPA2_met_clusterExecuter(tmpDir,i,j,batchID)
addpath(genpath('~/cobratoolbox/'));
addpath ./input/
addpath ./../scripts/
addpath ./../scripts/oriMERGE/
addpath ./../../bins/
load([tmpDir,'/variables.mat'],'model','master_expression','distMat','labels','nSeq','maxDist','blockList','constantPenalty','manualDist','penalty','targetRxns','environment','base','alpha','distMat_raw');
...
%         targetCmp = targetCmp{1};
        ...
        [FluxPotential_met_f] = FPA2_cluster_multiPara_highIO(model_tmp,{targetrxn_fullName},master_expression,distMat_2,labels_2,nSeq, {},manualDist,maxDist,blockList,constantPenalty,0,penalty_defined_2,base,alpha);
        ...
        [FluxPotential_met_r] = FPA2_cluster_multiPara_highIO(model_tmp,{targetrxn_fullName},master_expression,distMat_2,labels_2,nSeq, {},manualDist,maxDist,blockList,constantPenalty,0,penalty_defined_2,base,alpha);
