function [FluxPotentials_2d] = FPA2_clusterWrapper_multiPara(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,alpha, base)
...
save([tmpDir,'/variables.mat'],'model','master_expression','distMat','labels','nSeq','manualDist','maxDist','blockList', 'constantPenalty','parforFlag','penalty','targetRxns','environment','base','alpha','-v7.3','-nocompression');
