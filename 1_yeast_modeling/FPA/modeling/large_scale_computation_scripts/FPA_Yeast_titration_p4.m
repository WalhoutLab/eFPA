...
%% FPA: wtd distance and exponential decay
[FP_collection_2] = FPA2_cluster_simple_decay(model,targetRxns,{},distMat_wtd,labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro);
save('output/Titration_relativeExp_wtdDist_simpleDecay.mat','FP_collection_2','targetRxns','n2');
