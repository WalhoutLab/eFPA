...
n2 = 0:0.5:40;
alpha = 1;
eng_suffix = 'fine_titration_simDecay';
%% FPA
[FP_collection_2] = FPA2_cluster_simple_decay_eng(model,targetRxns,{},distMat_wtd,labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},true,penalty_pro,alpha, distMat_normal,labels, eng_suffix);
save('output/Titration_relativeExp_wtdDist_simpleDecay_FineGrained.mat','FP_collection_2','targetRxns','n2');
