...
targetRxns = rxnLabel;
%% improved FPA: orginal distance, exponential decay
n2 = [0 1 2 2.5 3 3.5 4 5 6 7 8 9 10 20 50];
base = [1.5 2 2.5 3 5 10 100 1000];
...
save('output/Titration_relativeExp_oriDist_expDecay.mat','FP_collection_2','targetRxns','n2','base');
