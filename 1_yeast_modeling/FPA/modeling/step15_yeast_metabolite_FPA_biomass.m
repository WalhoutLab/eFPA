...
alpha = 1;
%% the target set
targetRxns = cellfun(@(x) ['NewMet_',x],metTbl.MetaboliteModelName,'UniformOutput',false);
%% FPA
[FP_collection_2] = FPA2_met_clusterWrapper_multiPara(model,targetRxns,{},distMat_wtd, distMat_raw_wtd, labels,6, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},false,penalty_pro,alpha,2);
save(['output/metaboliteFPA_default_FPA.mat'],'FP_collection_2','targetRxns');

[FP_collection_2] = FPA2_met_clusterWrapper_simpleDecay(model,targetRxns,{},distMat_wtd,distMat_raw_wtd, labels,n2, manualPenalty,{},max(distMat_wtd(~isinf(distMat_wtd))),blocklist, {},false,penalty_pro,alpha);
save(['output/metaboliteFPA_flexible_FPA.mat'],'FP_collection_2','targetRxns');
