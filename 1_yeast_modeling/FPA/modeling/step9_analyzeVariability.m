%% About 
% we analyzed the variability of the fluxes and expressions here
% this defines the cutoff for assigning reactions as highly variable or not
%% load input data
...
% therefore the AUCk of 0.3473 is good
