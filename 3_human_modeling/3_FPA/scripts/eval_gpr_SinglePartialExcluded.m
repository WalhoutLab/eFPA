function [result, status] = eval_gpr_SinglePartialExcluded(rule, genes, levels, f_and, f_or)
...
if isempty(expression)
    ...
    % exclude partial measurements 
    if status == PARTIAL_MEASUREMENTS && total_measured == 1
        result = 'NaN';
    end
end
