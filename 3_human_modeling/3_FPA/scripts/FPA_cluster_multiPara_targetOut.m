function [FluxPotentials_all,FluxPotential_solutions_all] = FPA_cluster_multiPara_targetOut(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,alpha)
...
if parforFlag
    for nInd = 1:length(nSeq)
        ...
        if length(nSeq) > 1
            ...
            % dont save many solutions for now
        else
