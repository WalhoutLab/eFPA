setEnvForAnalysis
%%
load output/FPA_rxn_protein_TS_all_newFPA_weightedDist_order6_tissueNetwork.mat
...
load output/FPA_rxn_protein_raw_all_newFPA_weightedDist_order6_tissueNetwork.mat
relFP = [relFP_f;relFP_r];
relFP(rmInd,:) = [];
relFP_raw = relFP;
%% thresholding
...
relFP_filtered2 = normalize(relFP_filtered,2);
