function [FluxPotentials,FluxPotential_solutions] = MET_FPA2_oriMERGE_base2_clusterWrapper(model,targetRxns,master_expression,distMat,distMat_raw,labels,n,manualPenalty,manualDist,maxDist,blockList, helperMet, constantPenalty,parforFlag,penalty_defined,alpha)
