function [FluxPotentials_2d,FluxPotential_solutions_2d] = FPA2(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,base)
