function [FluxPotentials_all,FluxPotential_solutions_all] = FPA_cluster_multiPara(model,targetRxns,master_expression,distMat,labels,nSeq,manualPenalty,manualDist,maxDist,blockList, constantPenalty,parforFlag,penalty_defined,alpha)
