...
%% prepare paremeters
nSeq = [0:0.5:10,15, 20, 50]; % the distance order sequence to titrate
...
parfor i = 1:length(nSeq)
    ...
    penalty_defined_X_2 = [penalty_defined_X; ones(1,size(penalty_defined_X,2))];
    ...
    [fluxEfficiency_X_met(i,:),fluxEfficiency_plus_X_met(i,:)] = FPA2_oriMERGE(model_tmp,{targetrxn_fullName},master_expression,distMat_X_2,labels_X_2,n, manualPenalty2,manualDist,maxDist,blockList,constantPenalty2,false,penalty_defined_X_2);
    ...
    penalty_defined_I_2 = [penalty_defined_I; ones(1,size(penalty_defined_I,2))];
    ...
    [fluxEfficiency_I_met(i,:),fluxEfficiency_plus_I_met(i,:)] = FPA2_oriMERGE(model_tmp,{targetrxn_fullName},master_expression,distMat_I_2,labels_I_2,n, manualPenalty,manualDist,maxDist,blockList_I,constantPenalty,false,penalty_defined_I_2);
end
%% get the relative FP
