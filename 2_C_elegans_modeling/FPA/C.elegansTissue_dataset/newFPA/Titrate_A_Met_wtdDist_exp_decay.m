...
function [relFP_f,relFP_r, FluxPotential_solutions_X,FluxPotential_solutions_I] = Titrate_A_Met_wtdDist_exp_decay(targetObj,nSeq)
...
FluxPotential_X_met = cell(length(nSeq),size(penalty,2));
FluxPotential_solutions_X_met = cell(length(nSeq),size(penalty,2));
FluxPotential_I_met = cell(length(nSeq),size(penalty,2));
FluxPotential_solutions_I_met = cell(length(nSeq),size(penalty,2));
parfor i = 1:length(nSeq)
    restoreEnvironment(environment);
    n = nSeq(i);
    targetExRxns = targetObj;
    %% for demand reactions
    if contains(targetExRxns{1},'DMN') || contains(targetExRxns{1},'SNK') % demand reaction; note in the dual model, 'SNK' is actually demand, the uptake direction is replaced by 'UPK' reactions
        ...
        [FluxPotential_X_met(i,:),FluxPotential_solutions_X_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{[targetExRxns{1},'_X']},master_expression,distMat,labels,n, manualPenalty2,manualDist,maxDist,blockList,constantPenalty2,false,penalty_defined_X);
        % then, for intestine
        model_tmp = model;
        ...
        [FluxPotential_I_met(i,:),FluxPotential_solutions_I_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{[targetExRxns{1},'_I']},master_expression,distMat,labels,n, manualPenalty,manualDist,maxDist,blockList_I,constantPenalty,false,penalty_defined_I);
    %% for sink or uptake reaction
    elseif contains(targetExRxns{1},'UPK') % sink is called 'UPK' in dual model
        ...
        model_tmp.ub(ismember(model_tmp.rxns,myRxns_X)) = 0;
        model_tmp.lb(ismember(model_tmp.rxns,myRxns_X)) = 0;
        [FluxPotential_X_met(i,:),FluxPotential_solutions_X_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{[targetExRxns{1},'_X']},master_expression,distMat,labels,n, manualPenalty2,manualDist_tmp_X,maxDist,blockList,constantPenalty2,false,penalty_defined_X);
        model_tmp = model;
        myRxns_I = myRxns(cellfun(@(x) ~isempty(regexp(x,'(_L|_I)$','once')),myRxns));
        model_tmp.ub(ismember(model_tmp.rxns,myRxns_I)) = 0;
        model_tmp.lb(ismember(model_tmp.rxns,myRxns_I)) = 0;
        [FluxPotential_I_met(i,:),FluxPotential_solutions_I_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{[targetExRxns{1},'_I']},master_expression,distMat,labels,n, manualPenalty,manualDist_tmp_I,maxDist,blockList_I,constantPenalty,false,penalty_defined_I);
    ...
    elseif contains(targetExRxns{1},'TCE') % transporter reactions
        ...
        [FluxPotential_X_met_f,FluxPotential_solutions_X_met_f] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat,labels,n, manualPenalty2,manualDist,maxDist,blockList,constantPenalty2,false,penalty_defined_X);
        ...
        [FluxPotential_I_met_f,FluxPotential_solutions_I_met_f] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat,labels,n, manualPenalty,manualDist,maxDist,blockList_I,constantPenalty,false,penalty_defined_I);
        ...
        [FluxPotential_X_met_r,fluxEfficiency_plus_X_met_r] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat,labels,n, manualPenalty2,manualDist,maxDist,blockList,constantPenalty2,false,penalty_defined_X);
        ...
        [FluxPotential_I_met_r,FluxPotential_solutions_I_met_r] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat,labels,n, manualPenalty,manualDist,maxDist,blockList_I,constantPenalty,false,penalty_defined_I);
    ...
    elseif contains(targetExRxns{1},'NewMet_') % new demand reaction needed for metabolite in question
        ...
        model_tmp.ub(ismember(model_tmp.rxns,myRxns_X)) = 0;
        model_tmp.lb(ismember(model_tmp.rxns,myRxns_X)) = 0;
        [FluxPotential_X_met(i,:),FluxPotential_solutions_X_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat_X_2,labels_X_2,n, manualPenalty2,manualDist,maxDist,blockList,constantPenalty2,false,penalty_defined_X_2);
        ...
        model_tmp.ub(ismember(model_tmp.rxns,myRxns_I)) = 0;
        model_tmp.lb(ismember(model_tmp.rxns,myRxns_I)) = 0;
        [FluxPotential_I_met(i,:),FluxPotential_solutions_I_met(i,:)] = FPA2_oriMERGE_eng(model_tmp,{targetrxn_fullName},master_expression,distMat_I_2,labels_I_2,n, manualPenalty,manualDist,maxDist,blockList_I,constantPenalty,false,penalty_defined_I_2);
    else
        error('Not a supported RXN type!');
    end
end
%% get the relative FP
FluxPotential_solutions_X =FluxPotential_solutions_X_met;
FluxPotential_solutions_I = FluxPotential_solutions_I_met;

fluxEfficiency_X = [FluxPotential_X_met];
fluxEfficiency_I = [FluxPotential_I_met];
...
hold on
for i = 1:length(tissueLabel)
    plot(nSeq, relFP_f(:,i),'.-','LineWidth',3);
end
legend(tissueLabel);
