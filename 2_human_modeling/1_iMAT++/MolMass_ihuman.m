...
function MM = MolMass_plus(substance)
...
X	= 111.06;	%use average protein MW in protein pool (111.06) supp tabel 1!  XL 12042020
R	= 236.6;	% use average R MW in fatty acid pool (Supp tbl 1)! 280.625842 - 44.01  XL 12042020
